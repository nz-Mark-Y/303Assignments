...
/* DESCRIPTION: Handles button interrupts for pedestrian buttons
...
void init_buttons_pio(void) {
	...
	alt_irq_register(BUTTONS_IRQ,context_going_to_be_passed, button_interrupts_function); 	// register the ISR
}
